...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    lifeInMotionSubtitle: "Beyond the code and pixels, these are the passions that fuel my creativity and shape my perspective on life.",
    shareTheExperience: "Share the Experience",
    shareTheExperienceSubtitle: "Whether you want to jam on guitar, explore the city on wheels, or dive into epic gaming sessions, I believe the best experiences are shared with others.",
    ...
    guitarStory: "Started with a cheap acoustic guitar and fell in love with the way six strings could express what words couldn't. From metal riffs to gentle fingerpicking, each style opened a new dimension of creativity.",
    ...
    artStory: "Art has been my constant companion since childhood. What started as doodles in school notebooks evolved into digital masterpieces and character designs that tell their own stories.",
    ...
    skateStory: "Started skateboarding as a way to explore the city differently. Every curb became a challenge, every staircase an opportunity. The skateboarding community taught me perseverance and creativity.",
    ...
    gamingStory: "Gaming opened doors to infinite worlds where I could be anyone and do anything. From the challenging lands of Elden Ring to strategic battles, each game teaches patience, problem-solving, and creativity.",
  ...
  pt: {
    ...
    lifeInMotionSubtitle: "Além do código e pixels, essas são as paixões que alimentam minha criatividade e moldam minha perspectiva de vida.",
    shareTheExperience: "Compartilhe a Experiência",
    shareTheExperienceSubtitle: "Se você quer tocar guitarra, explorar a cidade sobre rodas, ou mergulhar em sessões épicas de jogos, acredito que as melhores experiências são compartilhadas com outros.",
    ...
    guitarDescription: "Cada acorde conta uma história, cada riff captura uma emoção. A música é minha linguagem universal.",
    guitarStory: "Comecei com uma guitarra acústica barata e me apaixonei pela forma como seis cordas podiam expressar o que as palavras não conseguiam. Dos riffs de metal ao fingerpicking suave, cada estilo abriu uma nova dimensão de criatividade.",
    ...
    artStory: "A arte tem sido minha companheira constante desde a infância. O que começou como rabiscos em cadernos da escola evoluiu para obras-primas digitais e designs de personagens que contam suas próprias histórias.",
    ...
    skateStory: "Comecei a andar de skate como uma forma de explorar a cidade de forma diferente. Cada meio-fio se tornou um desafio, cada escadaria uma oportunidade. A comunidade do skate me ensinou perseverança e criatividade.",
    ...
    skateCuriosity2: "A pior queda que levei foi tentando um kickflip numa escada de 6 degraus - ainda tenho a cicatriz",
    ...
    gamingDescription: "Conquistando mundos digitais, resolvendo quebra-cabeças complexos e vivendo mil histórias diferentes.",
    gamingStory: "Os jogos abriram portas para mundos infinitos onde eu podia ser qualquer um e fazer qualquer coisa. Das terras desafiadoras de Elden Ring às batalhas estratégicas, cada jogo ensina paciência, resolução de problemas e criatividade.",
